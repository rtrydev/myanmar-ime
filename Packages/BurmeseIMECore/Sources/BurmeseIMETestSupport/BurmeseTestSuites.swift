...
public enum BurmeseTestSuites {
    public static let all: [TestSuite] = [
        ...
        LexiconPhantomDigitFreeRankZeroSuite.suite,
        ...
        MidSentenceAhaPrefixAfterBoundarySuite.suite,
        ApostropheRaConsonantBoundarySuite.suite,
        DoubledClusterMedialConsistencySuite.suite,
        CuratedAliasRankZeroSuite.suite,
